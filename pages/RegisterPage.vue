<template>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-300" style="background-image: url('https://static.vecteezy.com/system/resources/previews/002/889/408/original/water-splash-background-free-vector.jpg');">
      <div class="flex flex-col bg-blue-300 shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
        ...
        <div class="relative mt-10 h-px bg-gray-300">
          <div class="absolute left-0 top-0 flex justify-center w-full -mt-2">
            <span class="bg-blue-200 px-4 text-xs text-gray-500 uppercase">Create account</span>
          </div>
        </div>
        <div class="mt-10">
          <form action="#">
